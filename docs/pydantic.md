...
> [!NOTE]
> The conversion of a custom class to its Avro representation must be provided in pydantic's [`json_encoders`](https://docs.pydantic.dev/1.10/usage/exporting_models/#json_encoders) config.
