...
class MyModelCustomEncoder(AvroBaseModel):
    ...
    class Meta:
        custom_encoders = {timedelta: timedelta_encoder}


MyModelCustomEncoder.generate_schema()


def test_custom_encoder_field():
    field_name = "custom_encoder"
    custom_encoder_field = AvroField(
        field_name, timedelta, MyModelCustomEncoder, model_metadata=MyModelCustomEncoder.get_metadata()
    )
...
def test_custom_encoder_field_with_default():
    ...
    custom_encoder_field = AvroField(
        field_name, timedelta, MyModelCustomEncoder, default=default, model_metadata=MyModelCustomEncoder.get_metadata()
    )
