...
PRIMITIVE_TYPES = (
    ...
    #     (pydantic.AnyUrl, field_utils.STRING),
    #     (pydantic.AnyHttpUrl, field_utils.STRING),
    #     (pydantic.HttpUrl, field_utils.STRING),
    #     (pydantic.FileUrl, field_utils.STRING),
    #     (pydantic.PostgresDsn, field_utils.STRING),
    #     (pydantic.CockroachDsn, field_utils.STRING),
    #     (pydantic.AmqpDsn, field_utils.STRING),
    #     (pydantic.RedisDsn, field_utils.STRING),
    #     (pydantic.MongoDsn, field_utils.STRING),
    #     (pydantic.KafkaDsn, field_utils.STRING),
    #     (pydantic.SecretStr, field_utils.STRING),
    #     (pydantic.IPvAnyAddress, field_utils.STRING),
    #     (pydantic.IPvAnyInterface, field_utils.STRING),
    #     (pydantic.IPvAnyNetwork, field_utils.STRING),
)
